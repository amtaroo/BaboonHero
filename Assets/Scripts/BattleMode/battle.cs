...
public class battle : MonoBehaviour
{
    ...
    public void CollectTrash(bool correctDisposal, bool isPlayer)
    {
        collectedTrashItems++;
    ...
    void EndGame()
    {
        ...
        finalPlayerScoreText.text = "Player Score : " + playerScore;
        finalMonkeyScoreText.text = "Monkey Score : " + monkeyScore;
        StopAllCoroutines();
    }
}
